package Snake.web_web_Interactions
...
//      }
  ...
  def inputKey(keyCode: KeyCode): Unit = {
    keyCode.getName match {
      case "Up" => socket.emit("keyState", "w", "ricky");
      case "Left" => socket.emit("keyState", "a", "ricky");
      case "Down" => socket.emit("keyState", "s", "ricky");
      case "Right" => socket.emit("keyState", "d", "ricky");
